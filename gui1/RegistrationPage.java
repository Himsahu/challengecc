...
public class RegistrationPage extends JDialog {
	...
	public RegistrationPage() {
		...
		lblRegistorNewUser.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		nameTextField.setText("e.g. Himanshu Sahu");
		...
		emailTextField.setText("e.g. himsahu.hs@gmail.com");
		...
		addressTextField.setText("e.g. Los Angeles, IA");
		...
		phonenumTextField.setText("e.g. 9875543221");
